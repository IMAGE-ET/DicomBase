...
namespace UIH.RT.TMS.Dicom.Iod.ContextGroups
{
	partial class ContextGroupBase<T>
	{
		...
		public abstract class ContextGroupItemBase : IEquatable<ContextGroupItemBase>, IEquatable<CodeSequenceMacro>
		{
			...
			/// by calling <see cref="Equals(UIH.RT.TMS.Dicom.Iod.Macros.CodeSequenceMacro)"/> or <see cref="Equals(UIH.RT.TMS.Dicom.Iod.ContextGroups.ContextGroupBase{T}.ContextGroupItemBase)"/>.
			/// </remarks>
			...
			/// <remarks>
			/// The default implementation compares only the coding scheme designator and code value
			/// by calling <see cref="Equals(UIH.RT.TMS.Dicom.Iod.Macros.CodeSequenceMacro,bool)"/>.
			/// </remarks>
			...
			/// <remarks>
			/// The default implementation compares only the coding scheme designator and code value
			/// by calling <see cref="Equals(UIH.RT.TMS.Dicom.Iod.ContextGroups.ContextGroupBase{T}.ContextGroupItemBase,bool)"/>.
			/// </remarks>
