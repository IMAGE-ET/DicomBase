...
namespace UIH.RT.TMS.Dicom.Iod.Modules
{
	...
	public class BasicFilmBoxModuleIod : IodBase
	{
		...
		/// Initializes a new instance of the <see cref="FilmBoxModuleIod"/> class.
		/// </summary>
		public BasicFilmBoxModuleIod(IDicomElementProvider dicomElementProvider) : base(dicomElementProvider) {}
		...
		{
			get { return ImageDisplayFormat.FromDicomString(base.DicomElementProvider[DicomTags.ImageDisplayFormat].GetString(0, String.Empty)); }
			set { base.DicomElementProvider[DicomTags.ImageDisplayFormat].SetStringValue(value.DicomString); }
		}
		...
		{
			get { return base.DicomElementProvider[DicomTags.AnnotationDisplayFormatId].GetString(0, String.Empty); }
			set { base.DicomElementProvider[DicomTags.AnnotationDisplayFormatId].SetString(0, value); }
		}
		...
		{
			get { return ParseEnum<FilmOrientation>(base.DicomElementProvider[DicomTags.FilmOrientation].GetString(0, String.Empty), FilmOrientation.None); }
			set { SetAttributeFromEnum(base.DicomElementProvider[DicomTags.FilmOrientation], value, false); }
		}
		...
		public FilmSize FilmSizeId
		{
			...
			set { SetAttributeFromEnum(base.DicomElementProvider[DicomTags.FilmSizeId], value.DicomString, false); }
		}
		...
		{
			get { return ParseEnum<MagnificationType>(base.DicomElementProvider[DicomTags.MagnificationType].GetString(0, String.Empty), MagnificationType.None); }
			set { SetAttributeFromEnum(base.DicomElementProvider[DicomTags.MagnificationType], value, false); }
		}
		...
		{
			get { return ParseEnum<SmoothingType>(base.DicomElementProvider[DicomTags.SmoothingType].GetString(0, String.Empty), SmoothingType.None); }
			set { SetAttributeFromEnum(base.DicomElementProvider[DicomTags.SmoothingType], value, false); }
		}
		...
		{
			get { return ParseEnum<BorderDensity>(base.DicomElementProvider[DicomTags.BorderDensity].GetString(0, String.Empty), BorderDensity.None); }
			set { SetAttributeFromEnum(base.DicomElementProvider[DicomTags.BorderDensity], value, false); }
		}
		...
		{
			get { return ParseEnum<EmptyImageDensity>(base.DicomElementProvider[DicomTags.EmptyImageDensity].GetString(0, String.Empty), EmptyImageDensity.None); }
			set { SetAttributeFromEnum(base.DicomElementProvider[DicomTags.EmptyImageDensity], value, false); }
		}
		...
		{
			get { return base.DicomElementProvider[DicomTags.MinDensity].GetUInt16(0, 0); }
			set { base.DicomElementProvider[DicomTags.MinDensity].SetUInt16(0, value); }
		}
		...
		{
			get { return base.DicomElementProvider[DicomTags.MaxDensity].GetUInt16(0, 0); }
			set { base.DicomElementProvider[DicomTags.MaxDensity].SetUInt16(0, value); }
		}
		...
		{
			get { return ParseEnum<DicomBoolean>(base.DicomElementProvider[DicomTags.Trim].GetString(0, String.Empty), DicomBoolean.None); }
			set { SetAttributeFromEnum(base.DicomElementProvider[DicomTags.Trim], value, false); }
		}
		...
		public string ConfigurationInformation
		{
			...
			set { base.DicomElementProvider[DicomTags.ConfigurationInformation].SetStringValue(value); }
		}
		...
		{
			get { return base.DicomElementProvider[DicomTags.Illumination].GetUInt16(0, 0); }
			set { base.DicomElementProvider[DicomTags.Illumination].SetUInt16(0, value); }
		}
		...
		{
			get { return base.DicomElementProvider[DicomTags.ReflectedAmbientLight].GetUInt16(0, 0); }
			set { base.DicomElementProvider[DicomTags.ReflectedAmbientLight].SetUInt16(0, value); }
		}
		...
		{
			get { return ParseEnum<RequestedResolution>(base.DicomElementProvider[DicomTags.RequestedResolutionId].GetString(0, String.Empty), RequestedResolution.None); }
			set { SetAttributeFromEnum(base.DicomElementProvider[DicomTags.RequestedResolutionId], value, false); }
		}

		public SequenceIodList<ReferencedInstanceSequenceIod> ReferencedFilmSessionSequenceList
		{
			get { return new SequenceIodList<ReferencedInstanceSequenceIod>(base.DicomElementProvider[DicomTags.ReferencedFilmSessionSequence] as DicomElementSq); }
		}

		public SequenceIodList<ReferencedInstanceSequenceIod> ReferencedImageBoxSequenceList
		{
			get { return new SequenceIodList<ReferencedInstanceSequenceIod>(base.DicomElementProvider[DicomTags.ReferencedImageBoxSequence] as DicomElementSq); }
		}

		public SequenceIodList<ReferencedInstanceSequenceIod> ReferencedBasicAnnotationBoxSequenceList
		{
			get { return new SequenceIodList<ReferencedInstanceSequenceIod>(base.DicomElementProvider[DicomTags.ReferencedBasicAnnotationBoxSequence] as DicomElementSq); }
		}
