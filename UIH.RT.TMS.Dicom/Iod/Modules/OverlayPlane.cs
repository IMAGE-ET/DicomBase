...
namespace UIH.RT.TMS.Dicom.Iod.Modules
{
	...
	public class OverlayPlaneModuleIod : IodBase, IEnumerable<OverlayPlane>
	{
		...
		/// Initializes a new instance of the <see cref="OverlayPlaneModuleIod"/> class.
		/// </summary>
		public OverlayPlaneModuleIod(IDicomElementProvider dicomElementProvider) : base(dicomElementProvider) {}
		...
		public OverlayPlane this[int index]
		{
			get
			{
				...
				return new OverlayPlane(index, this.DicomElementProvider);
			}
		}
		...
		public bool HasOverlayPlane(int index)
		{
			if (index < 0 || index >= 16)
				return false;
			DicomElement attrib;
			if (!base.DicomElementProvider.TryGetAttribute(ComputeTagOffset(index) + DicomTags.OverlayBitPosition, out attrib))
				return false;
			else if (attrib != null)
	...
	public class OverlayPlane : IodBase
	{
		...
		{
			get { return ByteBuffer.LocalMachineEndian == Endian.Big && base.DicomElementProvider[_tagOffset + DicomTags.OverlayData] is DicomElementOw; }
		}
		...
		public bool HasOverlayData
		{
			get
			{
				DicomElement element = base.DicomElementProvider[_tagOffset + DicomTags.OverlayData];
				return !element.IsEmpty && !element.IsNull;
			}
		}
		...
		{
			get { return base.DicomElementProvider[_tagOffset + DicomTags.OverlayRows].GetInt32(0, 0); }
			set { base.DicomElementProvider[_tagOffset + DicomTags.OverlayRows].SetInt32(0, value); }
		}
		...
		{
			get { return base.DicomElementProvider[_tagOffset + DicomTags.OverlayColumns].GetInt32(0, 0); }
			set { base.DicomElementProvider[_tagOffset + DicomTags.OverlayColumns].SetInt32(0, value); }
		}
		...
		{
			get { return ParseEnum(base.DicomElementProvider[_tagOffset + DicomTags.OverlayType].GetString(0, string.Empty), OverlayType.None); }
			set
			{
				if (value == OverlayType.None)
					throw new ArgumentOutOfRangeException("value", "OverlayType is Type 1 Required.");
				SetAttributeFromEnum(base.DicomElementProvider[_tagOffset + DicomTags.OverlayType], value, true);
			}
		}
		...
		public Point? OverlayOrigin
		{
			get
			{
				DicomElement element = base.DicomElementProvider[_tagOffset + DicomTags.OverlayOrigin];
				int[] result = new int[2];
				if (element.TryGetInt32(0, out result[0]))
					if (element.TryGetInt32(1, out result[1]))
			...
			set
			{
				...
				DicomElement element = base.DicomElementProvider[_tagOffset + DicomTags.OverlayOrigin];
				element.SetInt32(0, value.Value.X);
				element.SetInt32(1, value.Value.Y);
			}
		}
		...
		{
			get { return base.DicomElementProvider[_tagOffset + DicomTags.OverlayBitsAllocated].GetInt32(0, 0); }
			set
			{
				if (value != 1)
				...
				base.DicomElementProvider[_tagOffset + DicomTags.OverlayBitsAllocated].SetInt32(0, value);
			}
		}
		...
		{
			get { return base.DicomElementProvider[_tagOffset + DicomTags.OverlayBitPosition].GetInt32(0, 0); }
			set
			{
				if (value != 0)
				...
				base.DicomElementProvider[_tagOffset + DicomTags.OverlayBitPosition].SetInt32(0, value);
			}
		}
		...
		{
			get { return (byte[]) base.DicomElementProvider[_tagOffset + DicomTags.OverlayData].Values; }
			set
			{
				if (value == null || value.Length == 0)
					throw new ArgumentNullException("value", "OverlayData is Type 1 Required.");
				base.DicomElementProvider[_tagOffset + DicomTags.OverlayData].Values = value;
			}
		}
		...
		{
			get { return base.DicomElementProvider[_tagOffset + DicomTags.OverlayDescription].GetString(0, string.Empty); }
			set
			{
				if (string.IsNullOrEmpty(value))
				{
					base.DicomElementProvider[_tagOffset + DicomTags.OverlayDescription] = null;
					return;
				}
				base.DicomElementProvider[_tagOffset + DicomTags.OverlayDescription].SetString(0, value);
			}
		}
		...
		{
			get { return OverlaySubtype.FromDefinedTerm(base.DicomElementProvider[_tagOffset + DicomTags.OverlaySubtype].GetString(0, string.Empty)); }
			set
			{
				if (value == null)
				{
					base.DicomElementProvider[_tagOffset + DicomTags.OverlaySubtype] = null;
					return;
				}
				base.DicomElementProvider[_tagOffset + DicomTags.OverlaySubtype].SetString(0, value.DefinedTerm);
			}
		}
		...
		{
			get { return base.DicomElementProvider[_tagOffset + DicomTags.OverlayLabel].GetString(0, string.Empty); }
			set
			{
				if (string.IsNullOrEmpty(value))
				{
					base.DicomElementProvider[_tagOffset + DicomTags.OverlayLabel] = null;
					return;
				}
				base.DicomElementProvider[_tagOffset + DicomTags.OverlayLabel].SetString(0, value);
			}
		}
		...
		public int? RoiArea
		{
			...
			{
				int result;
				if (base.DicomElementProvider[_tagOffset + DicomTags.RoiArea].TryGetInt32(0, out result))
					return result;
				return null;
			}
			set
			{
				if (!value.HasValue)
				{
					base.DicomElementProvider[_tagOffset + DicomTags.RoiArea] = null;
					return;
				}
				base.DicomElementProvider[_tagOffset + DicomTags.RoiArea].SetInt32(0, value.Value);
			}
		}
		...
		public double? RoiMean
		{
			...
			{
				double result;
				if (base.DicomElementProvider[_tagOffset + DicomTags.RoiMean].TryGetFloat64(0, out result))
					return result;
				return null;
			}
			set
			{
				if (!value.HasValue)
				{
					base.DicomElementProvider[_tagOffset + DicomTags.RoiMean] = null;
					return;
				}
				base.DicomElementProvider[_tagOffset + DicomTags.RoiMean].SetFloat64(0, value.Value);
			}
		}
		...
		public double? RoiStandardDeviation
		{
			...
			{
				double result;
				if (base.DicomElementProvider[_tagOffset + DicomTags.RoiStandardDeviation].TryGetFloat64(0, out result))
					return result;
				return null;
			}
			set
			{
				if (!value.HasValue)
				{
					base.DicomElementProvider[_tagOffset + DicomTags.RoiStandardDeviation] = null;
					return;
				}
				base.DicomElementProvider[_tagOffset + DicomTags.RoiStandardDeviation].SetFloat64(0, value.Value);
			}
		}
		...
		public int? NumberOfFramesInOverlay
		{
			...
			{
				int result;
				if (base.DicomElementProvider[_tagOffset + DicomTags.NumberOfFramesInOverlay].TryGetInt32(0, out result))
					return result;
				return null;
			}
			set
			{
				if (!value.HasValue)
				{
					base.DicomElementProvider[_tagOffset + DicomTags.NumberOfFramesInOverlay] = null;
					return;
				}
				base.DicomElementProvider[_tagOffset + DicomTags.NumberOfFramesInOverlay].SetInt32(0, value.Value);
			}
		}
		...
		public int? ImageFrameOrigin
		{
			...
			{
				int result;
				if (base.DicomElementProvider[_tagOffset + DicomTags.ImageFrameOrigin].TryGetInt32(0, out result))
					return result;
				return null;
			}
			set
			{
				if (!value.HasValue)
				{
					base.DicomElementProvider[_tagOffset + DicomTags.ImageFrameOrigin] = null;
					return;
				}
				base.DicomElementProvider[_tagOffset + DicomTags.ImageFrameOrigin].SetInt32(0, value.Value);
			}
		}
