...
namespace UIH.RT.TMS.Dicom
{
    ...
    public class DicomMessage : DicomMessageBase
    {
        ...
        /// <summary>
        /// A <see cref="DicomDataset"/> instance representing the group 0x000 elements within the message.
        /// </summary>
        public DicomDataset CommandSet
        {
            get { return MetaInfo; }
        }
        ...
        public DicomMessage(DicomDataset command, DicomDataset data)
        {
            MetaInfo = command ?? new DicomDataset(0x00000000, 0x0000FFFF);

            DataSet = data ?? new DicomDataset(0x00040000,0xFFFFFFFF);
        }
        ...
        public DicomMessage(DicomFile file)
        {
            ...
            MetaInfo = new DicomDataset(0x00000000,0x0000FFFF);
