...
public:
	...
	virtual property UIH::RT::TMS::Dicom::TransferSyntax^ CodecTransferSyntax { UIH::RT::TMS::Dicom::TransferSyntax^ get(); };
...
public:
    ...
    property UIH::RT::TMS::Dicom::TransferSyntax^ CodecTransferSyntax { virtual UIH::RT::TMS::Dicom::TransferSyntax^ get() override; };
