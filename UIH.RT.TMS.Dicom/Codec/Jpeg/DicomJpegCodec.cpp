...
using namespace UIH::RT::TMS::Dicom::Codec;
using namespace UIH::RT::TMS::Dicom;
using namespace UIH::RT::TMS::Common;
...
namespace Jpeg {
	...
	UIH::RT::TMS::Dicom::TransferSyntax^ DicomJpegCodec::CodecTransferSyntax::get()
	{ 
		return nullptr;
	}
	
	UIH::RT::TMS::Dicom::TransferSyntax^ DicomJpegProcess1Codec::CodecTransferSyntax::get()  {
		return UIH::RT::TMS::Dicom::TransferSyntax::JpegBaselineProcess1;
	}
	String^ DicomJpegProcess1Codec::Name::get()  {
		return UIH::RT::TMS::Dicom::TransferSyntax::JpegBaselineProcess1->Name;	
	}
	...
	String^ DicomJpegProcess24Codec::Name::get()  {
		return UIH::RT::TMS::Dicom::TransferSyntax::JpegExtendedProcess24->Name;	
	}
	...
	String^ DicomJpegLossless14Codec::Name::get()  {
		return UIH::RT::TMS::Dicom::TransferSyntax::JpegLosslessNonHierarchicalProcess14->Name;	
	}

    UIH::RT::TMS::Dicom::TransferSyntax^ DicomJpegLossless14SV1Codec::CodecTransferSyntax::get()  {
		return UIH::RT::TMS::Dicom::TransferSyntax::JpegLosslessNonHierarchicalFirstOrderPredictionProcess14SelectionValue1;
	}
	String^ DicomJpegLossless14SV1Codec::Name::get()  {
		return UIH::RT::TMS::Dicom::TransferSyntax::JpegLosslessNonHierarchicalFirstOrderPredictionProcess14SelectionValue1->Name;	
	}
