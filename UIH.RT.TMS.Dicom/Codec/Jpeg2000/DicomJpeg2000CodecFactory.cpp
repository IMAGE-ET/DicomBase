...
namespace Jpeg2000 {
	...
	UIH::RT::TMS::Dicom::TransferSyntax^ DicomJpeg2000LosslessCodecFactory::CodecTransferSyntax::get()  {
		return UIH::RT::TMS::Dicom::TransferSyntax::Jpeg2000ImageCompressionLosslessOnly;
	}
	String^ DicomJpeg2000LosslessCodecFactory::Name::get()  {
		return UIH::RT::TMS::Dicom::TransferSyntax::Jpeg2000ImageCompressionLosslessOnly->Name;	
	}
	...
	String^ DicomJpeg2000LossyCodecFactory::Name::get()  {
		return UIH::RT::TMS::Dicom::TransferSyntax::Jpeg2000ImageCompression->Name;	
	}
