...
OPJ_COLOR_SPACE getOpenJpegColorSpace(String^ photometricInterpretation) {
	...
	UIH::RT::TMS::Dicom::TransferSyntax^ DicomJpeg2000Codec::CodecTransferSyntax::get()
	{ 
		return nullptr;
	}
	
	UIH::RT::TMS::Dicom::TransferSyntax^ DicomJpeg2000LossyCodec::CodecTransferSyntax::get()  {
	...
	UIH::RT::TMS::Dicom::TransferSyntax^ DicomJpeg2000LosslessCodec::CodecTransferSyntax::get()  {
