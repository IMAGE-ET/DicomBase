...
////
//// File: DicomElementMultiValueText.cs
////
//// Summary:
////
////
...
using UIH.RT.TMS.Dicom.Validation;
using UIH.RT.TMS.Dicom;

namespace UIH.RT.TMS.Dicom
{
    #region DicomElementMultiValueText
    /// <summary>
    /// <see cref="DicomElement"/> derived class for storing character based DICOM value representation attributes with multiple values.
    /// </summary>
    public abstract class DicomElementMultiValueText : DicomElement
    {
        ...
        internal DicomElementMultiValueText(uint tag)
            : base(tag)
        {

        }

        internal DicomElementMultiValueText(DicomTag tag)
            : base(tag)
        {

        }

        internal DicomElementMultiValueText(DicomTag tag, ByteBuffer item)
            : base(tag)
        {
            string valueArray;
        ...
        internal DicomElementMultiValueText(DicomElementMultiValueText attrib)
            : base(attrib)
        {
        ...
        /// <summary>
        /// Validate a string to be used as an element value
        /// Throw DicomDataException if string cannot be used as a value for the element.
        /// </summary>
    	...
    	/// <summary>
    	/// The number of values assigned to the element.
    	/// </summary>
    	...
    	/// <summary>
    	/// The length in bytes if the element was placed in a DICOM stream.
    	/// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            DicomElementMultiValueText a = (DicomElementMultiValueText)obj;
        ...
        /// <summary>
        /// Retrieve a value in the element 
        /// </summary>
        ...
        /// <exception cref="DicomDataException">If <i>stringValue</i> cannot values that cannot be convert into the element VR</exception>
        /// <example>
        ///     DicomElementDt attr = new DicomElementDt(DicomTagDictionary.GetDicomTag(DicomTags.AccessionNumber));
        ...
        /// 
        ///     DicomElementUs attrib = new DicomElementUs(DicomTagDictionary.GetDicomTag(DicomTags.SelectorUsValue));
    ...
    #region DicomElementAE
    /// <summary>
    /// <see cref="DicomElementMultiValueText"/> derived class for storing AE value representation attributes.
    /// </summary>
    public class DicomElementAE : DicomElementMultiValueText
    {
        #region Constructors

        public DicomElementAE(uint tag)
            : base(tag)
        {

        }

        public DicomElementAE(DicomTag tag)
            : base(tag)
        {
        ...
        internal DicomElementAE(DicomTag tag, ByteBuffer item)
            : base(tag, item)
        {
        }

        internal DicomElementAE(DicomElementAE attrib)
            : base(attrib)
        {
        }
        ...
        {
            return new DicomElementAE(this);
        }
    ...
    #region DicomElementAs
    /// <summary>
    /// <see cref="DicomElementMultiValueText"/> derived class for storing AS value representation attributes.
    /// </summary>
    public class DicomElementAs : DicomElementMultiValueText
    {
        #region Constructors

        public DicomElementAs(uint tag)
            : base(tag)
        {

        }

        public DicomElementAs(DicomTag tag)
            : base(tag)
        {
        ...
        internal DicomElementAs(DicomTag tag, ByteBuffer item)
            : base(tag, item)
        {
        }

        internal DicomElementAs(DicomElementAs attrib)
            : base(attrib)
        {
        }
        ...
        public override DicomElement Copy()
        {
            return new DicomElementAs(this);
        }
    ...
    #region DicomElementCs
    /// <summary>
    /// <see cref="DicomElementMultiValueText"/> derived class for storing CS value representation attributes.
    /// </summary>
    public class DicomElementCs : DicomElementMultiValueText
    {
        #region Constructors

        public DicomElementCs(uint tag)
            : base(tag)
        {

        }

        public DicomElementCs(DicomTag tag)
            : base(tag)
        {
        ...
        internal DicomElementCs(DicomTag tag, ByteBuffer item)
            : base(tag, item)
        {
        }

        internal DicomElementCs(DicomElementCs attrib)
            : base(attrib)
        {
        }
        ...
        public override DicomElement Copy()
        {
            return new DicomElementCs(this);
        }
    ...
    #region DicomElementDa
    /// <summary>
    /// <see cref="DicomElementMultiValueText"/> derived class for storing DA value representation attributes.
    /// </summary>
    public class DicomElementDa : DicomElementMultiValueText
    {

        #region Constructors

        public DicomElementDa(uint tag)
            : base(tag)
        {
        }

        public DicomElementDa(DicomTag tag)
            : base(tag)
        {
            if (!tag.VR.Equals(DicomVr.DAvr)
                && !tag.MultiVR)
        ...
        internal DicomElementDa(DicomTag tag, ByteBuffer item)
            : base(tag, item)
        {
        }

        internal DicomElementDa(DicomElementDa attrib)
            : base(attrib)
        {
        }
        ...
        public override DicomElement Copy()
        {
            return new DicomElementDa(this);
        }
        ...
        /// <summary>
        /// Method to retrieve a datetime value from a DA element.
        /// 
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
    ...
    #region DicomElementDs
    /// <summary>
    /// <see cref="DicomElementMultiValueText"/> derived class for storing DS value representation attributes.
    /// </summary>
    /// 
    public class DicomElementDs : DicomElementMultiValueText
    {
        protected NumberStyles _numberStyle = NumberStyles.Any;
        
        #region Constructors

        public DicomElementDs(uint tag)
            : base(tag)
        {

        }

        public DicomElementDs(DicomTag tag)
            : base(tag)
        {
        ...
        internal DicomElementDs(DicomTag tag, ByteBuffer item)
            : base(tag, item)
        {
        }

        internal DicomElementDs(DicomElementDs attrib)
            : base(attrib)
        {
        }
        ...
        public override DicomElement Copy()
        {
            return new DicomElementDs(this);
        }
        ...
        public override void AppendFloat32(float value)
        {
			...
			// Originallly had R here, but ran into problems with the element value being too large
        ...
        /// <summary>
        /// Method to retrieve an Int16 value from a DS element.
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        /// <returns><i>true</i>if value can be retrieved. <i>false</i> otherwise (see remarks)</returns>
        ...
        /// <summary>
        /// Method to retrieve an Int32 value from a DS element.
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        /// <returns><i>true</i>if value can be retrieved. <i>false</i> otherwise (see remarks)</returns>
        ...
        /// <summary>
        /// Method to retrieve an Int64 value from a DS element.
         /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        /// <returns><i>true</i>if value can be retrieved. <i>false</i> otherwise (see remarks)</returns>
        ...
        /// <summary>
        /// Method to retrieve an UInt16 value from a DS element.
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        /// <returns><i>true</i>if value can be retrieved. <i>false</i> otherwise (see remarks)</returns>
        ...
        /// <summary>
        /// Method to retrieve an UInt32 value from a DS element.
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        /// <returns><i>true</i>if value can be retrieved. <i>false</i> otherwise (see remarks)</returns>
        ...
        /// <summary>
        /// Method to retrieve an UInt64 value from a DS element.
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        /// <returns><i>true</i>if value can be retrieved. <i>false</i> otherwise (see remarks)</returns>
        ...
        /// <summary>
        /// Method to retrieve a float value from a DS element.
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        /// <returns><i>true</i>if value can be retrieved. <i>false</i> otherwise (see remarks)</returns>
        ...
        /// <summary>
        /// Method to retrieve a double value from a DS element.
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        /// <returns><i>true</i>if value can be retrieved. <i>false</i> otherwise (see remarks)</returns>
    ...
    #region DicomElementDt
    /// <summary>
    /// <see cref="DicomElementMultiValueText"/> derived class for storing DT value representation attributes.
    /// </summary>
    /// 
    public class DicomElementDt : DicomElementMultiValueText
    {
        #region Constructors

        public DicomElementDt(uint tag)
            : base(tag)
        {

        }

        public DicomElementDt(DicomTag tag)
            : base(tag)
        {
        ...
        internal DicomElementDt(DicomTag tag, ByteBuffer item)
            : base(tag, item)
        {
        }

        internal DicomElementDt(DicomElementDt attrib)
            : base(attrib)
        {
        }
        ...
        public override DicomElement Copy()
        {
            return new DicomElementDt(this);
        }
        ...
        /// <summary>
        /// Method to retrieve a datetime value from a DT element.
        /// 
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
    ...
    #region DicomElementIs
    /// <summary>
    /// <see cref="DicomElementMultiValueText"/> derived class for storing IS value representation attributes.
    /// </summary>
    public class DicomElementIs : DicomElementMultiValueText
    {
        protected NumberStyles _numberStyle = NumberStyles.Any;

        #region Constructors

        public DicomElementIs(uint tag)
            : base(tag)
        {

        }

        public DicomElementIs(DicomTag tag)
            : base(tag)
        {
        ...
        internal DicomElementIs(DicomTag tag, ByteBuffer item)
            : base(tag, item)
        {
        }

        internal DicomElementIs(DicomElementIs attrib)
            : base(attrib)
        {
        }
        ...
        public override DicomElement Copy()
        {
            return new DicomElementIs(this);
        }
        ...
        /// <summary>
        /// Method to retrieve an Int16 value from an IS element.
        /// 
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Method to retrieve an Int32 value from an IS element.
        /// 
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Method to retrieve an Int64 value from an IS element.
        /// 
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Method to retrieve an UInt16 value from an IS element.
        /// 
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Method to retrieve an UInt32 value from an IS element.
        /// 
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Method to retrieve an UInt64 value from an IS element.
        /// 
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Method to retrieve a float value from an IS element.
        /// 
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Method to retrieve a double value from an IS element.
        /// 
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
    ...
    #region DicomElementLo
    /// <summary>
    /// <see cref="DicomElementMultiValueText"/> derived class for storing LO value representation attributes.
    /// </summary>
    public class DicomElementLo : DicomElementMultiValueText
    {
        #region Constructors

        public DicomElementLo(uint tag)
            : base(tag)
        {

        }

        public DicomElementLo(DicomTag tag)
            : base(tag)
        {
        ...
        internal DicomElementLo(DicomElementLo attrib)
            : base(attrib)
        {
        }

        internal DicomElementLo(DicomTag tag, ByteBuffer item)
            : base(tag, item)
        {
        }
        ...
        public override DicomElement Copy()
        {
            return new DicomElementLo(this);
        }
    ...
    #region DicomElementPn
    /// <summary>
    /// <see cref="DicomElementMultiValueText"/> derived class for storing PN value representation attributes.
    /// </summary>
    public class DicomElementPn : DicomElementMultiValueText
    {
        #region Constructors

        public DicomElementPn(uint tag)
            : base(tag)
        {

        }

        public DicomElementPn(DicomTag tag)
            : base(tag)
        {
        ...
        internal DicomElementPn(DicomTag tag, ByteBuffer item)
            : base(tag, item)
        {
        }

        internal DicomElementPn(DicomElementPn attrib)
            : base(attrib)
        {
        }
        ...
        public override DicomElement Copy()
        {
            return new DicomElementPn(this);
        }
    ...
    #region DicomElementSh
    /// <summary>
    /// <see cref="DicomElementMultiValueText"/> derived class for storing SH value representation attributes.
    /// </summary>
    public class DicomElementSh : DicomElementMultiValueText
    {
        #region Constructors

        public DicomElementSh(uint tag)
            : base(tag)
        {

        }

        public DicomElementSh(DicomTag tag)
            : base(tag)
        {
        ...
        internal DicomElementSh(DicomTag tag, ByteBuffer item)
            : base(tag, item)
        {
        }

        internal DicomElementSh(DicomElementSh attrib)
            : base(attrib)
        {
        }
        ...
        public override DicomElement Copy()
        {
            return new DicomElementSh(this);
        }
    ...
    #region DicomElementTm
    /// <summary>
    /// <see cref="DicomElementMultiValueText"/> derived class for storing TM value representation attributes.
    /// </summary>
    public class DicomElementTm : DicomElementMultiValueText
    {
        #region Constructors

        public DicomElementTm(uint tag)
            : base(tag)
        {

        }

        public DicomElementTm(DicomTag tag)
            : base(tag)
        {
        ...
        internal DicomElementTm(DicomTag tag, ByteBuffer item)
            : base(tag, item)
        {
        }

        internal DicomElementTm(DicomElementTm attrib)
            : base(attrib)
        {
        }
        ...
        public override DicomElement Copy()
        {
            return new DicomElementTm(this);
        }
        ...
        /// <summary>
        /// Method to retrieve a datetime value from a TM element.
        /// 
        /// </summary>
        /// <param name="i"></param>
        /// <param name="value"></param>
    ...
    #region DicomElementUi
    /// <summary>
    /// <see cref="DicomElementMultiValueText"/> derived class for storing UI value representation attributes.
    /// </summary>
    public class DicomElementUi : DicomElementMultiValueText
    {
        #region Constructors

        public DicomElementUi(uint tag)
            : base(tag)
        {

        }

        public DicomElementUi(DicomTag tag)
            : base(tag)
        {
        ...
        internal DicomElementUi(DicomTag tag, ByteBuffer item)
            : base(tag, item)
        {
        }

        internal DicomElementUi(DicomElementUi attrib)
            : base(attrib)
        {
        }
        ...
        public override DicomElement Copy()
        {
            return new DicomElementUi(this);
        }
        ...
        /// <summary>
        /// Method to retrieve a DicomUI value from a UI element.
        /// 
        /// </summary>
        /// <param name="i"></param>
        ...
        /// <summary>
        /// Set a UI element value base on the content of the DicomUid object.
        /// 
        /// </summary>
        /// <param name="index"></param>
        /// <param name="value"></param>
