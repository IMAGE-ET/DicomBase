    ...
    public class ModalityWorklistScu : FindScuBase
    {
        ...
        public IList<ModalityWorklistIod> ModalityWorklistResults
        {
            get
            {
                ...
                {
                    foreach (DicomDataset dicomAttributeCollection in base.Results)
        ...
        {
			base.Find(clientAETitle, remoteAE, remoteHost, remotePort, modalityWorklistIod.DicomElementProvider as DicomDataset);
