...
////
//// File: DicomElementBinaryData.cs
////
//// Summary:
////
////
...
{
	/// <summary>
	/// Provides storage for the values of a <see cref="DicomElementBinary{T}"/>.
	/// </summary>
	/// <remarks>
	/// <para>
	/// By default, <see cref="DicomElementBinaryData{T}"/> implements storage with an array of <typeparamref name="T"/>.
	...
	/// </remarks>
	/// <typeparam name="T">The type of values stored by the element.</typeparam>
	public class DicomElementBinaryData<T> : IEnumerable<T>
		where T : struct
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new empty instance of <see cref="DicomElementBinaryData{T}"/>.
		/// </summary>
		public DicomElementBinaryData()
			: this(0) {}
		...
		/// <summary>
		/// Initializes a new instance of <see cref="DicomElementBinaryData{T}"/>, copying from an existing array of values.
		/// </summary>
		/// <param name="values">Source array of values.</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="values"/> is null.</exception>
		public DicomElementBinaryData(T[] values)
			: this(values, true) {}

		/// <summary>
		/// Initializes a new instance of <see cref="DicomElementBinaryData{T}"/> from an existing array of values.
		/// </summary>
		/// <param name="values">Source array of values.</param>
		/// <param name="copyArray">Indicates whether <paramref name="values"/> should be copied or if the array can be taken as owned by the <see cref="DicomElementBinaryData{T}"/>.</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="values"/> is null.</exception>
		public DicomElementBinaryData(T[] values, bool copyArray)
		{
		...
		/// <summary>
		/// Creates a <see cref="Stream"/> which maps to a view of this <see cref="DicomElementBinaryData{T}"/>, and can be used to read or write to the underlying values.
		/// </summary>
		/// <remarks>
		/// <para>
		...
		/// </para>
		/// </remarks>
		/// <returns>A new instance of a <see cref="Stream"/> which maps to a view of this <see cref="DicomElementBinaryData{T}"/>.</returns>
