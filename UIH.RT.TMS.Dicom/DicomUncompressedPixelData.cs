...
////
//// File: DicomUncompressedPixelData.cs
////
//// Summary:
////
////
...
namespace UIH.RT.TMS.Dicom
{
	...
	public class DicomUncompressedPixelData : DicomPixelData
	{
		...
		/// <summary>
		/// Constructor from an <see cref="DicomDataset"/> instance.
		/// </summary>
		/// <param name="collection"></param>
		public DicomUncompressedPixelData(DicomDataset collection)
			: base(collection)
		{
		...
		private void InitializeFrameData(DicomUncompressedPixelData owner, DicomElement pixelDataElement)
		{
			var obAttrib = pixelDataElement as DicomElementOb;
			...
			var owAttrib = pixelDataElement as DicomElementOw;
		...
		internal void UpdatePixelDataAttribute()
		{
			...
			using (var stream = ((DicomElementBinary) _pd).AsStream())
			{
				stream.Position = 0;
		...
		/// <summary>
		/// Update a <see cref="DicomDataset"/> with the pixel data contained
		/// within this object and also update pixel data related tags.
		/// </summary>
		/// <remarks>
		/// This method will replace the pixel data element in <paramref name="dataset"/>
		...
		/// <summary>
		/// Container representing frame data in an OB Pixel Data element.
		/// </summary>
		private class FrameDataOB : FrameData
		{
			private readonly DicomElementOb _obAttrib;
			private readonly int _frameIndex;

			/// <summary>
			/// Initializes the frame data container from an OB Pixel Data element.
			/// </summary>
			public FrameDataOB(DicomUncompressedPixelData owner, DicomElementOb pixelDataElement, int frameIndex)
				: base(owner)
			{
				_obAttrib = pixelDataElement;
		...
		/// <summary>
		/// Container representing frame data in an OW Pixel Data element.
		/// </summary>
		private class FrameDataOW : FrameData
		{
			private readonly DicomElementOw _owAttrib;
			private readonly int _frameIndex;

			/// <summary>
			/// Initializes the frame data container from an OW Pixel Data element.
			/// </summary>
			public FrameDataOW(DicomUncompressedPixelData owner, DicomElementOw pixelDataElement, int frameIndex)
				: base(owner)
			{
				_owAttrib = pixelDataElement;
				_frameIndex = frameIndex;
			}
