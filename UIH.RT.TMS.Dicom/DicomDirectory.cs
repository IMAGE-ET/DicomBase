...
namespace UIH.RT.TMS.Dicom
{
	...
	public class DicomDirectory : IDisposable
    {
        ...
        private readonly DicomElementSq _directoryRecordSequence;
        ...
        public DicomDirectory(string aeTitle)
        {
            try
            {
                ...
                _directoryRecordSequence = (DicomElementSq)_dicomDirFile.DataSet[DicomTags.DirectoryRecordSequence];
            }
            catch (Exception ex)
            {
        ...
        private static DirectoryRecordSequenceItem AddSequenceItem(DirectoryRecordType recordType, IDicomElementProvider dataSet, IDictionary<uint, object> tags)
        {
