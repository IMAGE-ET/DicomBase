...
{
    /// <summary>
    /// Abstract class representing a DICOM element within an element collection.
    /// </summary>
    /// <remarks>
    /// <para>
    /// The DicomElement class is a base class that represents a DICOM element.  A number of abstract methods are 
    /// defined.  Derived classes exist for each of the VR types.  In addition, the <see cref="DicomElementBinary"/>,
    ...
    public abstract class DicomElement
    {
        ...
        private DicomDataset _parentCollection = null;
        #endregion

        #region Abstract and Virtual Methods
        /// <summary>
        /// Method to return a string representation of the element.
        /// </summary>
        /// <returns></returns>
        ...
        public abstract DicomElement Copy();
        ...
        internal abstract DicomElement Copy(bool copyBinary);

        /// <summary>
        /// Calculate the length to write the element.
        /// </summary>
        ...
        /// when the element is saved using the specific character set and transfer syntax 
        ...
        /// <summary>
        /// Method to retrieve a <see cref="DateTime"/> element for the tag.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>This function only works for <see cref="DicomElementUi"/> attributes.</remarks>
        /// <param name="i"></param>
        /// <param name="value"></param>
        /// <returns>True on success, false on failure.</returns>
        ...
        /// <summary>
        /// The <see cref="DicomDataset"/> that the element is contained in.
        /// </summary>
        /// <remarks>
        /// This field is used to determine the Specific Character Set of a string element.
        /// </remarks>
        internal DicomDataset ParentCollection
        {
        ...
        internal DicomElement(DicomTag tag)
        {
			Tag = tag;
        }
        ...
        /// <summary>
        /// Internal constructor used when copying an element from a pre-existing element instance.
        /// </summary>
        /// <param name="attrib">The element that is being copied.</param>
        internal DicomElement(DicomElement attrib)
        {
            Tag = attrib.Tag;
    	...
    	/// <summary>
    	/// Retrieve <see cref="Tag"/> instance for the element.
    	/// </summary>
    	/// <remarks>
        ...
        /// </summary>
        public static implicit operator String(DicomElement attr)
        {
        ...
        #region Dump
        /// <summary>
        /// Method for dumping the contents of the element to a string.
        /// </summary>
        /// <param name="sb">The StringBuilder to write the element to.</param>
        ...
        public virtual void Dump(StringBuilder sb, string prefix, DicomDumpOptions options)
        {
            ...
            else
            {
                if (Tag.VR.IsTextVR)
                {
                    ...
                    {
                        DicomElementUi ui = this as DicomElementUi;
