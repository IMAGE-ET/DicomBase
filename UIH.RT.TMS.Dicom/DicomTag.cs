...
namespace UIH.RT.TMS.Dicom
{
    ...
    /// for each DICOM tag, and that instance will be shared in any <see cref="DicomDataset"/> 
    ...
    public class DicomTag : IComparable
    {
        ...
        /// <summary>
        /// This method creates a <see cref="DicomElement"/> derived class for the tag.
        /// </summary>
        /// <returns></returns>
        public DicomElement CreateDicomAttribute()
        {
            return _vr.CreateDicomAttribute(this);
        }
        /// <summary>
        /// This method creates a <see cref="DicomElement"/> derived class for the tag, and 
        ...
        /// <returns></returns>
        public DicomElement CreateDicomAttribute(ByteBuffer bb)
        {
